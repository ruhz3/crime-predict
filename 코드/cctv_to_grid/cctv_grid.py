...
load_wb = openpyxl.load_workbook("cctv.xlsx", data_only=True)
load_ws = load_wb['cctv']

# 새로운 엑셀 파일 생성(연도별 시트 생성)
wb = openpyxl.Workbook()
sheet = wb.create_sheet('cctv_grid')
sheet['A1'] = "번호"
sheet['B1'] = "주용도"
sheet['C1'] = "설치대수"
sheet['D1'] = "Latitude"
